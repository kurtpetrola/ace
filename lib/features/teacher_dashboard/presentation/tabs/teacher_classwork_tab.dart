// lib/features/teacher_dashboard/presentation/tabs/teacher_classwork_tab.dart
...
class TeacherClassworkTab extends StatefulWidget {
  final Classroom classroom;
  final String teacherId;

  const TeacherClassworkTab({
    super.key,
  ...
  @override
  State<TeacherClassworkTab> createState() => _TeacherClassworkTabState();
}

class _TeacherClassworkTabState extends State<TeacherClassworkTab>
  ...
  // We will simple use a filter variable instead of a nested TabController for simplicity and better UX inside a TabView
  String _currentFilter = 'All'; // 'Upcoming', 'Overdue', 'All'
  ...
  List<Classwork> _filterClasswork(String filter) {
  ...
  Widget build(BuildContext context) {
    final list = _filterClasswork(_currentFilter);
                ...
                : list.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return _buildClassworkItem(list[i]);
                        },
                      ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No $_currentFilter classwork found',
            style: TextStyle(
              fontSize: 18,
  ...
  Widget _buildClassworkItem(Classwork cw) {
                                ...
                                child: Text('OVERDUE',
                                    style: TextStyle(
                                        color: Theme.of(context)
                                            .textTheme
                                            .titleMedium
                                            ?.color, // Adjusted for potential theme clash but red usually stands out
                                        fontSize: 10,
                                        fontWeight: FontWeight.bold)),
                              )
                            ],
